...
### Bilgisayar Mühendisliği Öğrencisi @ Galatasaray Üniversitesi
...
- Kurumsal ilişkilerin yönetimi ve büyük ölçekli teknik etkinlikler için kaynak sağlanması.
- Öğrenci kolu faaliyetleri için bütçe planlaması ve sponsorluk operasyonlarının yürütülmesi.
...
## 🌐 Diller
- **Türkçe:** ![Anadil](https://img.shields.io/badge/Anadil-100%25-brightgreen)
- **İngilizce:** ![Profesyonel](https://img.shields.io/badge/Profesyonel-85%25-green)
- **Fransızca:** ![Sinirli](https://img.shields.io/badge/Sinirli-40%25-yellow) 

## 🛠 Teknik Yetkinlikler
- **Diller:** C, C++, Python
- **Mühendislik Araçları:** MATLAB, AutoCAD
- **Geliştirici Araçları:** Git, GitHub, JSON, Markdown
